...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Breakthrough Collection LLC — Inspired by Faith, Made with Love" },
      {
        name: "description",
        content:
          "Breakthrough Collection LLC is a faith-rooted gifting studio crafting personalized apparel, mugs, and curated gift sets with intention and love.",
      },
      { property: "og:title", content: "About Breakthrough Collection LLC" },
...
const VALUES = [
  {
    ...
    body: "Every piece passes through caring hands and a prayerful heart before it reaches your door.",
  },
  {
    icon: Sparkles,
    title: "Thoughtful Design",
    body: "We design for meaning — pieces that feel personal long after the wrapping is gone.",
  },
  {
    icon: PackageCheck,
    title: "Gift-Ready Always",
    body: "Hand-finished embroidery, signature navy boxes, and gold-ribbon detailing on every order.",
  },
  {
    icon: Truck,
    title: "Crafted in the USA",
    body: "Small-batch production from our family studio, shipped quickly from coast to coast.",
  },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 py-20 md:grid-cols-2 md:px-8 md:py-28">
        <div className="relative">
          <img
            src={ownerImg}
            alt="Rebecca, founder of Breakthrough Collection LLC"
            loading="lazy"
        ...
        <div>
          ...
          <h2 className="mt-3 font-display text-4xl md:text-5xl">
            A labor of love, stitch by stitch.
          </h2>
          <p className="mt-6 text-base leading-relaxed text-foreground/80">
            Breakthrough Collection LLC was founded in 2021, during the pandemic, by Rebecca and her
            three sons. What started as a creative outlet at the kitchen table — a single embroidery
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 py-20 md:grid-cols-2 md:px-8 md:py-28">
        <div>
          ...
          <p className="mt-6 text-base leading-relaxed text-foreground/80">
            Every mug, every sweatshirt, every gift box we ship is meant to remind someone they are
            seen, loved, and held. Whether it’s a milestone, a hard season, or simply a Tuesday —
            our pieces are made to carry meaning.
          </p>
          <div className="mt-8 grid grid-cols-3 gap-6 border-t border-border pt-6">
            <div>
              <div className="font-display text-3xl text-ink">500+</div>
            ...
            <div>
              <div className="font-display text-3xl text-ink">48h</div>
              <div className="mt-1 text-[11px] uppercase tracking-[0.2em] text-muted-foreground">
                Custom Turnaround
              </div>
            </div>
        ...
        <img
          src={catGifts}
          alt="A navy gift box tied with a gold ribbon"
          loading="lazy"
          className="aspect-[4/5] w-full rounded-sm object-cover"
        />
      </section>
